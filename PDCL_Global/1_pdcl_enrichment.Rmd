...
gmt_path <- list(
  ...
  reactome_categ_filtered = "../Data/gene-set/reactome_no_less_15_no_more_500_categ_filtered.gmt",
  kegg_categ_filtered = "../Data/gene-set/kegg_no_less_15_no_more_500_categ_filtered.gmt"
)
```
