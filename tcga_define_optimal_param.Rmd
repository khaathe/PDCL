...
all_penda_datasets <- lapply(1:length(simulated_cases), function(i){
...
all_simulated_datasets <- lapply(1:length(simulated_cases), function(i){
  data_simu <- simulated_cases[[i]]
...
size_grp <- 100
quant_simu <- 0.05
all_simulation <- lapply(1:length(all_simulated_datasets), function(i){
  data_ctrl <- all_penda_datasets[[i]]$data_ctrl
