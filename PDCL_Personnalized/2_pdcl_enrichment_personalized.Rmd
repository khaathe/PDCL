---
title: "2 - Personnalized Pathway Enrichment on PDCL"
output: 
...
result_dir <- "Result_2_pdcl_enrichment_personnalized/"
```
...
```{r load-penda}
penda_res <- readRDS("~/PhD/Project/PDCL/Data/PDCL/results_penda_astrocytes_2021.rds")
...
```{r save-session}
save.image("2_pdcl_enrichment_personnalized.RData")
```
