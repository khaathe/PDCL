...
## Alpha = 0.05
```{r plot-gsea-processed-genes-rank-5-percent}
gsea_processed_pathway_genes_0.05 <- plot.gsea.pathway.genes(rnk_processed_collapsed, gem_collapsed, "GSEA Processed",  0.05, 100)
ggsave(
  "Result/plot/alpha_0.05/gsea_processed_pathway_genes.png",
  plot = gsea_processed_pathway_genes_0.05,
  width = 24,
  height = 8
)
gsea_processed_pathway_genes_0.05
```

```{r heatmap-gsea-processed-genes-rank-5-percent}
heatmap_gsea_processed_pathway_genes_0.05 <- heatmap.gsea.gene.ranks(rnk_processed_collapsed, gem_collapsed, "GSEA Processed",  0.05, 100)
ggsave(
  "Result/plot/alpha_0.05/heatmap_gsea_processed_pathway_genes.png",
  plot = heatmap_gsea_processed_pathway_genes_0.05,
  width = 12,
  height = 16
)
heatmap_gsea_processed_pathway_genes_0.05
```

## Alpha = 0.1
```{r plot-gsea-processed-genes-rank-10-percent}
...
```{r heatmap-gsea-processed-genes-rank-10-percent}
...
```{r plot-common-pathway-genes-5-percent}
plot_common_pathway_genes_0.05 <- plot.common.pathway.genes(rnk_processed_collapsed, gem_collapsed, all_common_pathways, threshold, "G:Profiler", "GSEA Processed", "method_2", 100)
ggsave(
  "Result/plot/alpha_0.05/common_pathway_genes.png",
  plot = plot_common_pathway_genes_0.05,
  width = 20,
  height = 10
)
plot_common_pathway_genes_0.05
```

```{r heatmap-common-genes-rank-5-percent}
heatmap_common_pathway_genes_0.05 <- heatmap.common.gene.ranks(rnk_processed_collapsed, gem_collapsed, all_common_pathways, threshold, "G:Profiler", "GSEA Processed", "method_2", 100)
ggsave(
  "Result/plot/alpha_0.05/heatmap_common_pathway_genes_0.05.png",
  plot = heatmap_common_pathway_genes_0.05,
  width = 14,
  height = 20
)
heatmap_common_pathway_genes_0.05
```
...
```{r heatmap-pathways-gprofiler-vs-gsea-10-percent, fig.width=12, fig.height=6}
...
```{r heatmap-pathways-gprofiler-vs-gsea_processed-10-percent, fig.width=12, fig.height=6}
...
```{r heatmap-pathways-gsea-vs-gsea_processed-10-percent, fig.width=12, fig.height=6}
...
```{r plot-common-pathway-genes-10-percent}
...
```{r heatmap-common-genes-rank-10-percent}
