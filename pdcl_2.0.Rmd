...
## Alpha = 0.05
```{r plot-gsea-genes-rank-5-percent, fig.width=24, fig.height=8}
gsea_pathway_genes_0.05 <- plot.gsea.pathway.genes(rnk_collapsed, gem_collapsed, "GSEA",  0.05, 100)
ggsave(
  "Result/plot/alpha_0.05/gsea_pathway_genes.png",
  plot = gsea_pathway_genes_0.05,
  width = 24,
  height = 8
)
gsea_pathway_genes_0.05
```

```{r heatmap-gsea-genes-rank-5-percent, fig.width=12, fig.height=16}
heatmap_gsea_pathway_genes_0.05 <- heatmap.gsea.gene.ranks(rnk_collapsed, gem_collapsed, "GSEA",  0.05, 100)
ggsave(
  "Result/plot/alpha_0.05/heatmap_gsea_pathway_genes.png",
  plot = heatmap_gsea_pathway_genes_0.05,
  width = 12,
  height = 16
)
heatmap_gsea_pathway_genes_0.05
```

## Alpha = 0.1
```{r plot-gsea-genes-rank-10-percent, fig.width=24, fig.height=12}
gsea_pathway_genes_0.1 <- plot.gsea.pathway.genes(rnk_collapsed, gem_collapsed, "GSEA",  0.1, 100)
ggsave(
  "Result/plot/alpha_0.1/gsea_pathway_genes.png",
  plot = gsea_pathway_genes_0.1,
  width = 24,
  height = 12
)
gsea_pathway_genes_0.1
```

```{r heatmap-gsea-genes-rank-10-percent, fig.width=12, fig.height=16}
heatmap_gsea_pathway_genes_0.1 <- heatmap.gsea.gene.ranks(rnk_collapsed, gem_collapsed, "GSEA",  0.1, 100)
ggsave(
  "Result/plot/alpha_0.1/heatmap_gsea_pathway_genes.png",
  plot = heatmap_gsea_pathway_genes_0.1,
  width = 12,
  height = 16
)
heatmap_gsea_pathway_genes_0.1
```
...
There isn't any pathways with a FDR below 5% when processing the GSEA ranked list with PENDA results.

```{r num-res-gsea-processed-5-percent}
gem_collapsed %>% filter(method == "GSEA Processed", fdr < 0.05) %>% count()
```

## Alpha = 0.1

Number of pathways with a FDR value below 10% :

```{r num-res-gsea-processed-10-percent}
gem_collapsed %>% filter(method == "GSEA Processed", fdr < 0.1) %>% count()
```

```{r plot-gsea-processed-genes-rank-10-percent, fig.width=24, fig.height=12}
gsea_processed_pathway_genes_0.1 <- plot.gsea.pathway.genes(rnk_processed_collapsed, gem_collapsed, "GSEA Processed",  0.1, 100)
ggsave(
  "Result/plot/alpha_0.1/gsea_processed_pathway_genes.png",
  plot = gsea_processed_pathway_genes_0.1,
  width = 24,
  height = 12
)
gsea_processed_pathway_genes_0.1
```

```{r heatmap-gsea-processed-genes-rank-10-percent, fig.width=12, fig.height=16}
heatmap_gsea_processed_pathway_genes_0.1 <- heatmap.gsea.gene.ranks(rnk_processed_collapsed, gem_collapsed, "GSEA Processed",  0.1, 100)
ggsave(
  "Result/plot/alpha_0.1/heatmap_gsea_processed_pathway_genes.png",
  plot = heatmap_gsea_processed_pathway_genes_0.1,
  width = 12,
  height = 16
)
heatmap_gsea_processed_pathway_genes_0.1
```
...
gprofiler_vs_gsea <- plot_method_vs_method(gem_collapsed_method_vs_method, "G:Profiler", "GSEA", threshold)
ggsave(
  "Result/plot/alpha_0.1/plot_gprofiler_vs_gsea.png",
  plot = gprofiler_vs_gsea,
  width = 10,
  height = 7
)
...
ggsave(
  "Result/plot/alpha_0.1/plot_gprofiler_vs_gsea_processed.png",
...
ggsave(
  "Result/plot/alpha_0.1/plt_gsea_vs_gsea_processed.png",
...
ggsave(
  "Result/plot/alpha_0.1/plot_count_categories_0.1.png",
...
ggsave(
  "Result/plot/alpha_0.1/plot_count_categories_gprofiler_vs_gsea_0.1.png",
  plot = count_categories_gprofiler_vs_gsea_0.1,
  width = 10,
  height = 7
)
...
ggsave(
  "Result/plot/alpha_0.1/plot_count_categories_gprofiler_vs_gsea_processed_0.1.png",
  plot = count_categories_gprofiler_vs_gsea_processed_0.1,
  width = 10,
  height = 7
)
...
ggsave(
  "Result/plot/alpha_0.1/plot_count_categories_gsea_vs_gsea_processed_0.1.png",
  plot = count_categories_gsea_vs_gsea_processed_0.1,
  width = 10,
  height = 7
)
...
ggsave(
  "Result/plot/alpha_0.1/plot_count_pathways.png",
...
ggsave(
  "Result/plot/alpha_0.1/plot_count_pathways_gprofiler_vs_gsea.png",
  plot = count_pathways_gprofiler_vs_gsea_0.1,
  width = 10,
  height = 7
)
...
ggsave(
  "Result/plot/alpha_0.1/plot_count_pathways_gprofiler_vs_gsea_processed.png",
  plot = count_pathways_gprofiler_vs_gsea_processed_0.1,
  width = 10,
  height = 7
)
...
ggsave(
  "Result/plot/alpha_0.1/plot_count_pathways_gsea_vs_gsea_processed.png",
  plot = count_pathways_gsea_vs_gsea_processed_0.1,
  width = 10,
  height = 7
)
...
ggsave(
  "Result/plot/alpha_0.1/heatmap_pathways_gprofiler_vs_gsea.png",
  plot = heatmap_pathways_gprofiler_vs_gsea_0.1,
  width = 16,
  height = 10
)
...
ggsave(
  "Result/plot/alpha_0.1/heatmap_pathways_gprofiler_vs_gsea_processed.png",
  plot = heatmap_pathways_gprofiler_vs_gsea_processed_0.1,
  width = 16,
  height = 10
)
...
ggsave(
  "Result/plot/alpha_0.1/heatmap_pathways_gsea_vs_gsea_processed.png",
  plot = heatmap_pathways_gsea_vs_gsea_processed_0.1,
  width = 16,
  height = 10
)
...
ggsave(
  "Result/plot/alpha_0.1/heatmap_categories.png",
...
```{r plot-common-pathway-genes-10-percent, fig.width=20, fig.height=10}
plot_common_pathway_genes_0.1 <- plot.common.pathway.genes(rnk_processed_collapsed, gem_collapsed, all_common_pathways, threshold, "G:Profiler", "GSEA Processed", "method_2", 100)
ggsave(
  "Result/plot/alpha_0.1/common_pathway_genes.png",
  plot = plot_common_pathway_genes_0.1,
  width = 20,
  height = 10
)
plot_common_pathway_genes_0.1
```

```{r heatmap-common-genes-rank-10-percent, fig.width=14, fig.height=20}
heatmap_common_pathway_genes_0.1 <- heatmap.common.gene.ranks(rnk_processed_collapsed, gem_collapsed, all_common_pathways, threshold, "G:Profiler", "GSEA Processed", "method_2", 100)
ggsave(
  "Result/plot/alpha_0.1/heatmap_common_pathway_genes_0.1.png",
  plot = heatmap_common_pathway_genes_0.1,
  width = 14,
  height = 20
)
heatmap_common_pathway_genes_0.1
```
