...
plot_common_pathway_genes_0.05 <- plot.common.pathway.genes(rnk_processed_collapsed, gem_collapsed, all_common_pathways, threshold, "G:Profiler", "GSEA", "method_2", 100)
ggsave(
...
heatmap_common_pathway_genes_0.05 <- heatmap.common.gene.ranks(rnk_processed_collapsed, gem_collapsed, all_common_pathways, threshold, "G:Profiler", "GSEA", "method_2", 100)
ggsave(
...
plot_common_pathway_genes_0.1 <- plot.common.pathway.genes(rnk_processed_collapsed, gem_collapsed, all_common_pathways, threshold, "G:Profiler", "GSEA", "method_2", 100)
ggsave(
...
heatmap_common_pathway_genes_0.1 <- heatmap.common.gene.ranks(rnk_processed_collapsed, gem_collapsed, all_common_pathways, threshold, "G:Profiler", "GSEA", "method_2", 100)
ggsave(
