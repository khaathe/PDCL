...
This document aims to provide a reproducible analysis following the workflow 
described in the article `Exploration of the altered mechanisms of the tumour`
`cell using Differential Expression and Pathway Enrichment analysis: Application to glioblastoma`.
Only data from TCGA will be used in this document as data from PDCLs are not available.
The parameters of the different functions used for Differential Expression testing
and pathways enrichment won't be described in this document. Links to the relevant
...
count_data <- count_data[sample(1:59317, 30000),]
dim(count_data)
```
