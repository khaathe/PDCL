---
title: "TCGA-GBM : Define Optimal Parameters"
...
rerun_cache <- F 
result_dir <- "Result_0_tcga_define_optimal_param/"
```
...
set.seed(1)
# Generate all combinations of n-controls
...
save.image("0_tcga_define_optimal_param.RData")
```
